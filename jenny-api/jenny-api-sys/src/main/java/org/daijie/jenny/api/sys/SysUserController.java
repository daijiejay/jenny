...
public class SysUserController {
	...
	public ModelResult<SysUserResponse> deleteUser(@PathVariable("userId") Integer userId) {
		return sysUserFeign.deleteUser(userId);
	}

	@ApiOperation(value = "禁用用户")
	@RequestMapping(value = "/enable/{userId}", method = RequestMethod.PUT)
	public ModelResult<SysUserResponse> enableUser(@PathVariable("userId") Integer userId) {
		SysUserUpdateRequest sysUserRequest = new SysUserUpdateRequest();
	...
	public ModelResult<SysUserResponse> notenableUser(@PathVariable("userId") Integer userId) {
		SysUserUpdateRequest sysUserRequest = new SysUserUpdateRequest();
		sysUserRequest.setUserId(userId);
	...
	public ModelResult<SysUserResponse> updatePassword(@RequestBody SysUserUpdatePasswordRequest sysUserUpdatePasswordRequest) {
		...
		try {
			...
			if (!oldPassword.equals(passwordResponse.getPassword())) {
				return Result.build("旧密码错误", Result.ERROR, ResultCode.CODE_100);
			}
	...
	public ModelResult<SysUserResponse> resetPassword(@PathVariable("userId") Integer userId) {
		SysUserUpdateRequest sysUserRequest = new SysUserUpdateRequest();
		sysUserRequest.setUserId(userId);
		try {
	...
	public ModelResult<SysUserCacheResponse> loginUserCache() {
		...
		if (authc == null) {
			Result.build(ResultCode.CODE_300.getDescription(), Result.ERROR, ResultCode.CODE_300);
		}
