...
public class SysMenuController {
	...
	public ModelResult<PageResult<SysMenuResponse>> getMenuAll(@RequestBody SysMenuPageRequest sysMenuRequest) {
	...
	public ModelResult<SysMenuResponse> getMenu(@PathVariable("menuId") Integer menuId) {
	...
	public ModelResult<SysMenuResponse> deleteMenu(@PathVariable("menuId") Integer menuId) {
		return sysMenuFeign.deleteMenu(menuId);
	}
	
	@ApiOperation(value = "禁用菜单")
	@RequestMapping(value = "/enable/{menuId}", method = RequestMethod.PUT)
	public ModelResult<SysMenuResponse> enableMenu(@PathVariable("menuId") Integer menuId) {
	...
	public ModelResult<SysMenuResponse> notenableMenu(@PathVariable("menuId") Integer menuId) {
		SysMenuUpdateRequest sysMenuRequest = new SysMenuUpdateRequest();
		sysMenuRequest.setMenuId(menuId);
