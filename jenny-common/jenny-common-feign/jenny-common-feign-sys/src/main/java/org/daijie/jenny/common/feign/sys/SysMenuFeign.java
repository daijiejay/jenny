...
public interface SysMenuFeign {
	...
	@RequestMapping(value = "/sysmenu/query/all", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/sysmenu/update", method = RequestMethod.PUT)
	public ModelResult<SysMenuResponse> updateMenu(SysMenuRequest sysMenuRequest);

	@ApiOperation(notes = "删除菜单", value = "删除菜单")
	@RequestMapping(value = "/sysmenu/delete", method = RequestMethod.DELETE)
